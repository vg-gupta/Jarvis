...
path = 'www\\Sample' # Path for samples already taken

recognizer = cv2.face.LBPHFaceRecognizer_create() # Local Binary Patterns Histograms
detector = cv2.CascadeClassifier("www\\haarcascade_frontalface_default.xml")
...
recognizer.write('www\\trainer.yml')  # Save the trained model as trainer.yml
